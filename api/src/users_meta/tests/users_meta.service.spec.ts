...
import { PostsMetaService } from '@app/posts_meta/posts_meta.service';
import { Repository, UpdateResult } from 'typeorm';
import { PostsMeta } from '@app/posts_meta/entities/posts_meta.entity';
import { getRepositoryToken } from '@nestjs/typeorm';
import { NotFoundException, InternalServerErrorException } from '@nestjs/common';
import { CreatePostsMetaDto } from '@app/posts_meta/dto/create-posts_meta.dto';
import { UpdatePostsMetaDto } from '@app/posts_meta/dto/update-posts_meta.dto';
